...
public class FruitServiceTest {
	...
	public static WebArchive createDeployment() {
		WebArchive archive = ShrinkWrap.create(WebArchive.class, "rest-http-crud-test.war")
				.addPackages(true, "io.openliberty.example").addAsResource("META-INF/persistence.xml").addAsResource("META-INF/load.sql");
		return archive;
	}
    ...
    public void listFruits() {
        ...
        WebTarget target = client.target("http://localhost:9080/rest-http-crud-test")
                .path("/api")
                .path("/fruits");
    ...
    private JsonObject createNewFruit(String name) {
        ...
        Entity<Fruit> entity = Entity.entity(
                new Fruit(name),
